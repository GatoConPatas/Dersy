                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-warning shadow-primary border-radius-lg py-3 pe-1">
                                    ...
                                    <p class='text-light p-2 text-center justify-center'>Recibirás un correo electrónico en máximo 60 segundos.</p>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <form role="form" method="POST" action="{{ route('verify') }}" class="text-start">
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                            class="btn bg-gradient-warning w-100 my-4 mb-2">Enviar</button>
                                    </div>
