                    ...
                    <div class="card-body p-3">
                        ...
                        <form method='POST' action='{{ route('clientes.update', $cliente->id) }}'>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <!-- Aquí los campos para editar -->
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label">Nombre:</label>
                                            <input type="text" name="name" class="form-control border border-2 p-2" value='{{ old('name', $cliente->name) }}'>
                                            @error('name')
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" name="apellido" class="form-control border border-2 p-2" value='{{ old('apellido', $cliente->apellido) }}'>
                                            @error('apellido')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" name="dni" class="form-control border border-2 p-2" value='{{ old('dni', $cliente->dni) }}'>
                                            @error('dni')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="number" name="phoneNumber" class="form-control border border-2 p-2" value='{{ old('phoneNumber', $cliente->phoneNumber) }}'>
                                            @error('phoneNumber')
                                                <p class='text-danger inputerror'>{{ $message }}</p>
                                            @enderror
                                        </div>
