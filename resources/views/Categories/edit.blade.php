<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100 mt-3">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Editar Categoría'></x-navbars.navs.auth>
        <!-- End Navbar -->
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" name="name" class="form-control border border-2 p-2" value='{{ old('name',$category->name) }}'>
                                            @error('name')
